...
const { registerTransaction, listTransactions, detailTransaction, getStatement, updateTransaction, deleteTransaction } = require('./controllers/transactions');
...
routes.delete('/transactions/delete/:id', deleteTransaction);
